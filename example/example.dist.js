...
document.querySelector('button').addEventListener('click', function () {
  var client = new _index2.default('76e7eee216a88e19f68d034d9ab4afe4e9bd92ff38e2347c01fe05c482f55297');
...
var _uploadClient = require('./libs/uploadClient');

var _uploadClient2 = _interopRequireDefault(_uploadClient);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _uploadClient2.default;

},{"./libs/uploadClient":4}],3:[function(require,module,exports){
'use strict';
...
exports.default = function (anyObject) {
  return new Promise(function (resolve, reject) {
    if (typeof anyObject === 'string' && anyObject.substr(0, 5) === 'data:') {
      ...
      var ctx = canvas.getContext('2d');
      var width = anyObject.width;
      var height = anyObject.height;
      canvas.width = width;
...
var _any2dataUrl = require('./any2dataUrl');

var _any2dataUrl2 = _interopRequireDefault(_any2dataUrl);
...
var uploadClient = function () {
  function uploadClient(clientId) {
  ...
  _createClass(uploadClient, [{
    ...
    key: 'easyAuth',
    value: function easyAuth(imagedata, body) {
      var _this = this;

      if (imagedata) this.imagedata = imagedata;
      this.setBody(body);
      if (!this.imagedata) throw new Error('imagedata is empty');
      var reqUrl = this.host + this.apiEndPoint;
      return (0, _any2dataUrl2.default)(this.imagedata).then(function (dataUrl) {
        _this.setBody({ client_id: _this.clientId, image_url: dataUrl });
        return fetch(reqUrl, {
          method: 'POST',
          body: _this.formData()
        });
...
},{"./any2dataUrl":3,"whatwg-fetch":5}],5:[function(require,module,exports){
(function(self) {
  'use strict';
